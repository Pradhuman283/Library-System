...
public class Book {
    ...
    @ElementCollection
    @CollectionTable(name = "book_queue", joinColumns = @JoinColumn(name = "book_isbn"))
    @Column(name = "member_id")
    @OrderColumn(name = "queue_order")
    private List<Integer> bookQ = new LinkedList<>();
